...
CREATE TABLE `itemdonations` (
  ...
  `currentStocks` int(11) DEFAULT 0,
...
(1, 'Vitamins', NULL, 'Pet\'s vitamins provide essential nutrients and supplements to support the overall health and well-being of your beloved pets, ensuring they receive the necessary vitamins and minerals for optimal vitality.', 600, 5, 15, NULL),
(2, 'Foods', NULL, 'High-quality dog and cat food offers a balanced and nutritious diet, promoting proper growth, strong immune systems, and healthy digestion for your furry companions.', 499, 2, 15, NULL),
(3, 'Grooming', NULL, 'Grooming products help maintain the hygiene and appearance of your pets, keeping their coats clean, shiny, and free from tangles, while also providing soothing care for their skin.', 499, 2, 15, NULL),
(4, 'Water', NULL, 'Water is Life', 50, 0, 25, NULL);
...
INSERT INTO `materials` (`matId`, `title`, `content`, `author`, `datePosted`, `reference`, `status`) VALUES
...
(1007, 'Akoy', 'Cat', '5 years old', 'Vaccinated', 'Available', NULL);
...
(5, 'bryan@gmail.com', 'bryan123', 'Bryan Angel', 'Barrera', 19, '+639364325121', 'San Julian, Batac 2906', 'Ilocos Norte', NULL, 'User', NULL);
...
--
ALTER TABLE `pets`
  MODIFY `petId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1008;
